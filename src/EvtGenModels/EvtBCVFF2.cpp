...
void EvtBCVFF2::getvectorff(EvtId,EvtId,
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtBCVFF2.\n";  
    ::abort();
  };
}
...
void EvtBCVFF2::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtBCVFF2.\n";
  ::abort();
...
void EvtBCVFF2::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtBCVFF2.\n";
  ::abort();
