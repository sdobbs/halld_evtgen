...
void EvtLb2BaryonlnuFF::getdiracff(EvtId parent, EvtId daught,
  ...
  {
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Only Lb -> N*+ transitions allowed in EvtLb2BaryonlnuFF.\n";  
  ::abort();
  }
...
void EvtLb2BaryonlnuFF::getscalarff(EvtId, EvtId, double, double, double*, double*) {
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getscalarff in EvtLb2BaryonlnuFF.\n";  
  ::abort();
...
void EvtLb2BaryonlnuFF::getvectorff(EvtId, EvtId, double, double, double*, double*,
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getvectorff in EvtLb2BaryonlnuFF.\n";  
  ::abort();
...
void EvtLb2BaryonlnuFF::gettensorff(EvtId, EvtId, double, double, double*, double*,
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :gettensorff in EvtLb2BaryonlnuFF.\n";  
  ::abort();
...
void EvtLb2BaryonlnuFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtLb2BaryonlnuFF.\n";  
  ::abort();
