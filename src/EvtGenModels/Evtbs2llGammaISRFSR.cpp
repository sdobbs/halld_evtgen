...
void Evtbs2llGammaISRFSR::init(){
  ...
  if (!(photontype == EvtSpinType::PHOTON)) {
    EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Evtbs2llGammaISRFSR generator expected "
  ...
  if (photontype == EvtSpinType::PHOTON){
    ...
    EvtGenReport(EVTGEN_ERROR,"EvtGen") << "The init()-function in the Evtbs2llGammaISRFSR generator:"
...
void Evtbs2llGammaISRFSR::initProbMax(){
  ...
  if(mymaxprob <= 0.0){
     EvtGenReport(EVTGEN_ERROR,"EvtGen") << "The function void Evtbs2llGammaISRFSR::initProbMax()" 
