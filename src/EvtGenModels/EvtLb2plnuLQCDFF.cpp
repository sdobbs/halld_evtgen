...
void EvtLb2plnuLQCDFF::getdiracff(EvtId parent, EvtId daught,
  ...
  {
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Only Lb -> p transitions allowed in EvtLb2plnuLQCDFF.\n";  
  ::abort();
  }
...
void EvtLb2plnuLQCDFF::getraritaff( EvtId , EvtId ,
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtLb2plnuLQCDFF.\n";  
  ::abort();
...
void EvtLb2plnuLQCDFF::getscalarff(EvtId, EvtId, double, double, double*, double*) {
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getscalarff in EvtLb2plnuLQCDFF.\n";  
  ::abort();
...
void EvtLb2plnuLQCDFF::getvectorff(EvtId, EvtId, double, double, double*, double*,
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getvectorff in EvtLb2plnuLQCDFF.\n";  
  ::abort();
...
void EvtLb2plnuLQCDFF::gettensorff(EvtId, EvtId, double, double, double*, double*,
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :gettensorff in EvtLb2plnuLQCDFF.\n";  
  ::abort();
...
void EvtLb2plnuLQCDFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  EvtGenReport(EVTGEN_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtLb2plnuLQCDFF.\n";  
  ::abort();
